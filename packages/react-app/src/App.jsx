...
import "./App.css";
import { Row, Col, Button, Menu, Alert, Switch as SwitchD, AutoComplete } from "antd";
...
import { CreateTransaction, Transactions, Owners, FrontPage, Streams } from "./views"
...
function App(props) {
  ...
  // keep track of a variable from the contract in the local React state:
  const admin = useContractReader(readContracts, contractName, "admin")
  ...
  if (DEBUG) console.log("📟 writerEvents:", writerEvents)
